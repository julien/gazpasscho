...
function $render(opt_data, opt_ignored, opt_ijData) {
  soy.asserts.assertType(goog.isString(opt_data.page) || (opt_data.page instanceof goog.soy.data.SanitizedContent), 'page', opt_data.page, 'string|goog.soy.data.SanitizedContent');
  var page = /** @type {string|goog.soy.data.SanitizedContent} */ (opt_data.page);
  ie_open('div');
    if (page == 'home') {
